...
- thresh:
  ...
  a threshold for discretizing exposure: when the amount of exposure
  meets or exceeds this threshold, resulting exp is set to 1; if the
  amount of exposure is less than the threshold, the resulting exp is
  set to 0
