...
This is the general form that your survey dataset should have.  DENNIS, MORE HERE?
...
Note that the function alters you to the fact that it is working in absolute numbers,
instead of proportions (i.e., it is estimating a count of idus, not the prevalence of idus).
