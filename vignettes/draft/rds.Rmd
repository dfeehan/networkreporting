...
package installed. If you don't, please refer to the [README](https://github.com/dfeehan/networkreporting/blob/master/README.md). 
...
```{r}
dd <- networkreporting:::estimate.degree.distns(goc.survey.data,
